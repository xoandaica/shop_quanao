...
function CheckAuthentication()
{
    ...
    if(isset($_SESSION['ck_access'])&&$_SESSION['ck_access']==true){
        return true;
    }
...
$config['LicenseName'] = 'ToanNguyen';
$config['LicenseKey'] = 'F3UJS8JK6JTLRNVWWDL5VCJELGGP4S4T';
...
*/
$baseUrl = '/demo_nuhoangquanjean/upload/';
...
$_SESSION['CKFinder_UserRole'] =$_SESSION['quyenhan'];
//
