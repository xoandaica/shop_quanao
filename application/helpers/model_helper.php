...
function check_img_mobile($link=null,$alt){
    ...
    }else echo '<img class="w_100" src="'.base_url('img/no_image.jpg').'" style="border:1px solid rgba(0, 128, 0, 0.26)" />';
}
function check_img_newsbycate($link=null){
    if($link!=null&&file_exists($link)){
        echo '<img class="h_150px w_100" src="'.base_url($link).'" />';
    }else echo '<img class="h_150px w_100" src="'.base_url('img/no_image.jpg').'" style="border:1px solid rgba(0, 128, 0, 0.26)" />';
}
function check_img_products($link=null){
    if($link!=null&&file_exists($link)){
        echo '<img class="img_100 img_productchitiet" src="'.base_url($link).'"  />';
    }else echo '<img class="img_100 img_productchitiet" src="'.base_url('img/no_image.jpg').'" style="border:1px solid rgba(0, 128, 0, 0.26)" />';
}
function check_img_productsmobi($link=null){
    ...
    }else echo '<img class="img_100 img_product" src="'.base_url('img/no_image.jpg').'" style="border:1px solid rgba(0, 128, 0, 0.26)" />';
}
function check_img_product_chitiet($link=null){
    if($link!=null&&file_exists($link)){
        echo '<img class="w_60 h_100" u="image"  src="'.base_url($link).'" />';
    }else echo '<img class="w_60 h_100" u="image"  src="'.base_url('img/no_image.jpg').'" style="border:1px solid rgba(0, 128, 0, 0.26)" />';
}
...
function break_crum_product($type,$data=null,$id=null){
    if(is_array($data)&&$id!=null){
        if($type=='news'){$link='tin-tuc';}
        if($type=='products'){$link='danh-muc';}
