...
function online()
{
    ...
    $file1 = "assets/counter/online.log";
    $lines = file($file1);
    $line2 = "";
...
$file_ip = fopen('assets/counter/ip.txt', 'rb');
...
if (!($found==1)) {
    $file_ip2 = fopen('assets/counter/ip.txt', 'ab');
    $line = "$ip\n";
    fwrite($file_ip2, $line, strlen($line));
    $file_count = fopen('assets/counter/count.txt', 'rb');
    $data = '';
    ...
    $file_count2 = fopen('assets/counter/count.txt', 'wb');
