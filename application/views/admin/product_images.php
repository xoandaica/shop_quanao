        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?= base_url('vnadmin/product/images') ?>">Hình ảnh</a>
                    </li>
                    <?= @$images_lang;?>
                </ol>
            </div>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="panel panel-success" >
                            ...
                            <div class="row">
                                <form action="<?= base_url('vnadmin/product/images/' . $id) ?>" method="post"
                                      class="validate"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-xs">
                                        ...
                                        <a href="<?= base_url('vnadmin/product/delete_img/' . $v1->img_id) ?>"
    ...
    <script type="text/javascript">
        function getModal(id) {
            ...
            $.ajax({
                type: "POST",
                dataType: 'json',
                url: baseurl + 'admin/product/popupdata',
                data: {id:id},
                success: function (rs) {
                    if(rs.link!=null){
                    ...
                    var sc = '<form action="'+baseurl+'vnadmin/product/images/'+id_product+'" method="post"\
                        accept-charset="utf-8" enctype="multipart/form-data">\
