        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?= base_url('vnadmin/pages/pagelist') ?>">Danh sách pages <?= @$name_lang; ?></a>
                    </li>
                    <li>
                        <a href="<?= base_url('vnadmin/pages/images') ?>">Hình ảnh</a>
                    </li>
                    <?= @$images_lang;?>
                </ol>
            </div>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="panel panel-success" >
                            ...
                            <div class="row">
                                <form action="<?= base_url('vnadmin/pages/images/' . $id) ?>" method="post"
                                      class="validate"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-xs">
                                        ...
                                        <a href="<?= base_url('vnadmin/imageupload/delete/' . $v1->img_id) ?>"
    ...
    <script type="text/javascript">
        function getModal(id) {
            ...
            $.ajax({
                type: "POST",
                dataType: 'json',
                url: baseurl + 'admin/pages/popupdata',
                data: {id:id},
                success: function (rs) {
                    if(rs.link!=null){
                    ...
                    var sc = '<form action="'+baseurl+'vnadmin/pages/images/'+id_product+'" method="post"\
                        accept-charset="utf-8" enctype="multipart/form-data">\
                        <input name="edit"  type="hidden" value="'+id+'"/>\
                        <div class="col-xs-10" style="margin-bottom: 10px">\
                        <input name="title" id="userfile" type="text" value="'+rs.title+'"\
                        class="form-control input-sm"/>\
                        </div>\
                        <div class="col-md-10">\
