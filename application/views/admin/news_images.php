        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?= base_url('vnadmin/news/newslist') ?>">Danh sách tin tức</a>
                    </li>
                </ol>
            </div>
            <div class="clear"></div>
                    ...
                    <div class="modal-content">
                        <div class="panel panel-success" >
                            ...
                            <div class="row">
                                ...
                                <form action="<?= base_url('vnadmin/news/images/' . $id) ?>" method="post"
                                      class="validate"
                                      accept-charset="utf-8" enctype="multipart/form-data">

                                    <div class="col-xs-12" style="margin-bottom: 10px">
                                        <input name="name" id="userfile" type="text" placeholder="Tiêu đề"
            ...
            <div class="col-md-12">
                <table class="table table-hover">
                    ...
                    <?php if (isset($news_images)&& !empty($news_images)) {
                        $s=1;
                        foreach ($news_images as $v1) {
                            ?>
                            <tr>
                                <td><?= $s++; ?></td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group btn-group-xs">
                                        <a onclick="getModal(<?=$v1->img_id;?>)"
                                           ...
                                           class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i>
                                        </a>

                                        <a href="<?= base_url('vnadmin/news/delete_news_images/' . $v1->img_id) ?>"
    ...
    <script type="text/javascript">
        function getModal(id) {
            ...
            $.ajax({
                type: "POST",
                dataType: 'json',
                url: baseurl + 'admin/news/popupdata',
                data: {id:id},
                success: function (rs) {
                    if(rs.link!=null){
                    ...
                    var sc = '<form action="'+baseurl+'vnadmin/news/images/'+id_product+'" method="post"\
                        accept-charset="utf-8" enctype="multipart/form-data">\
                        <input name="edit"  type="hidden" value="'+id+'"/>\
                        <div class="col-xs-10" style="margin-bottom: 10px">\
                        <input name="name" id="userfile" type="text" value="'+rs.title+'"\
                        class="form-control input-sm"/>\
                        </div>\
                        <div class="col-md-10">\
