    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <a href="<?= base_url('vnadmin/personnel/personnels') ?>">Quản lý <?= _title_personnel?> </a>
                    </li> 
                    <?= @$images_lang; ?>
                </ol>
            </div>
            <div class="col-md-12">
                <div class="" style="padding-bottom: 15px">
                    <a href="<?= base_url('vnadmin/personnel/add') ?>" class="btn btn-success btn-sm">
        ...
        <script>
            ...
            $('.view_color').click(function(){
                ...
                $.ajax({
                    url: baseurl+"admin/personnel/update_cat_view",
                    type: 'POST',
                    dataType: 'json',
                    data: form_data,
                    success: function (rs) {
            ...
            function cat_sort(s){
                ...
                $.ajax({
                    url: baseurl+"admin/personnel/cat_sort",
                    type: 'POST',
                    dataType: 'json',
                    data: form_data,
                    success: function (rs) {
