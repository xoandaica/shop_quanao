            ...
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        ...
                        <a href="<?=base_url('vnadmin/news/newslist_recycle')?>"> Danh sách tin thùng rác<?= @$name_lang; ?> </a>
                    </li>
                    <li>
                ...
                <div class="row" style="padding-bottom: 15px">
                    ...
                    <div class="col-md-9" >
                        <form action="" method="get" class="row">
                            ...
                            <div class="col-sm-2 pull-right <?= @$display_lang; ?>">
                ...
                <div class="">
                    ...
                    <table class="table table-hover table-bordered">
                        <form action="<?= base_url('vnadmin/news/delete_check')?>" method="post" class="row">
                            <div class="col-md-3" style="padding: 0px; margin-bottom: 10px">
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">
                                            ...
                                            <div data-toggle="tooltip" data-placement="top" title="<?= _title_news_hot ?>"
                                                 ...
                                                 class='view_color' style='border: 1px solid #ff0000;margin-right: 10px;
                                            ...
                                            <div data-toggle="tooltip" data-placement="top" title="<?= _title_news_focus ?>"
                                                 ...
                                                 class='view_color' style='border: 1px solid #008855;margin-right: 10px;
                                            ...
                                            <div data-toggle="tooltip" data-placement="top" title="<?= _title_news_coupon ?>"
                                                 ...
                                                 class='view_color' style='border: 1px solid #B5027E;margin-right: 10px;
                                        ...
                                        <td width='13%' class="text-center">
                                            ...
                                            <a href="<?= base_url('vnadmin/news/images/' . $v->id) ?>"
                                               class="btn btn-xs btn-default" title="Ảnh Tin Tức"  ><i class="fa fa-image"></i></a>
                                            ...
                                            <a href="<?= base_url('vnadmin/news/recycle_hien/' . $v->id) ?>"
                                               onclick="return confirm('Bạn có chắc chắn muốn sử dụng lại tin này ?')"
                                               class="btn btn-xs btn-primary" title="Xóa" style="color: #fff"><i class="fa fa-recycle"></i> </a>
                                        </td>
                                    </tr>
                                <?php
                                }
