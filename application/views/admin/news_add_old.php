                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group display_none">
                                <label class="col-sm-12 control-label text-left lalbe_rv" style="text-align: left !important;">
...
//                                                if (file_exists($img->link)) {
                                                    ?>
                                                    <div class="img_group col-md-6">
                                                        <div class="remove_image_item pull-right">×</div>
                                                        <div class="clearfix"></div>
                                                        <input name="more_file[]" type="hidden" id="item_url<?= $img->id; ?>"
                                                               class="input-sm form-control" value="<?= $img->link; ?>">

                                                        <div id="id_item<?= $img->id; ?>" class="img_div">
                                                            <img src="<?= base_url($img->link); ?>" alt=""
                                                                 style="max-width: 100%;"/>
                                                        </div>
                                                        <div class="text-center">
                                                            <a class="select_image" style="cursor: pointer"
                                                               data-item="id_item<?= $img->id; ?>"
                                                               data-url="item_url<?= $img->id; ?>">Chọn</a> |
                                                            <a class="remove_image" style="cursor: pointer"
                                                               data-item="id_item<?= $img->id; ?>"
                                                               data-url="item_url<?= $img->id; ?>">Hủy</a>
                                                        </div>
                                                    </div>
                                                <?php
