    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <a href="<?= base_url('vnadmin/project/categories') ?>">
                           Danh mục
                        </a>
                    </li>
                    <?= @$images_lang; ?>
            ...
            <div class="col-md-12">
                ...
                <div class="" style="padding-bottom: 15px">
                    <a href="<?= base_url('vnadmin/project/cat_add') ?>" class="btn btn-success btn-sm">
                ...
                <div class=" ">
                    <table class="table table-striped table-bordered">
                        ...
                        <?php  view_project_cate_table($cate,0,'') ?>
        ...
        <script>
            ...
            $('.view_color').click(function(){
                ...
                $.ajax({
                    url: baseurl+"admin/project/update_cat_view",
                    type: 'POST',
                    dataType: 'json',
                    data: form_data,
                    success: function (rs) {
            ...
            function cat_sort(s){
                ...
                $.ajax({
                    url: baseurl+"admin/project/cat_sort",
                    type: 'POST',
                    dataType: 'json',
                    data: form_data,
                    success: function (rs) {
