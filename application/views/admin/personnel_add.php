        ...
        <div class="row">
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <a href="<?=base_url('vnadmin/personnel/personnels')?>">Danh sách <?= _title_personnel?></a>
                    </li> 
                    <li >
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="validate[required] form-control input-sm " name="desc"
