                            ...
                            <form action="" method="post" class="validate form-horizontal" role="form">
                                ...
                                <div class="controls" style="margin-left: 40%;">
                                    <input type="submit" name="sendcontact" id="signupuser"
                                           class="btn btn-primary" value="<?= lang('send') ?>"/>
                                    <input type="reset" id="mybtn" class="btn btn-primary" value="<?= lang('reset') ?>">
                                </div>
                                <!--end form-contact-->
                            </form>
                        </div>
                      ...
                      <div class="map">
                          <div class="map_group">
                              ...
                              <script type="text/javascript">
                                  ...
                                  function initialize() {
                                      var defaultLatLng = new google.maps.LatLng(21.013997, 105.769270);
                                      var myOptions = {zoom: 15, center: defaultLatLng, scrollwheel: false, mapTypeId: google.maps.MapTypeId.ROADMAP };
                                      map = new google.maps.Map(document.getElementById("map_canvas"), myOptions);
                                      map.setCenter(defaultLatLng);
                                      var arrLatLng = new google.maps.LatLng(21.013997, 105.769270);
                                      infoWindowArray[10349] = '<div class="map_description"><b> <?= @$this->site_name;?></b></br><strong>Địa chỉ: </strong>  42 Lê quang đạo </br><strong>Điện thoại: </strong><?= $this->hotline1?></div>';
