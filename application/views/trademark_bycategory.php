                        ...
                        <form role="form">
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm" id="sel1" onchange="window.open(this.options[this.selectedIndex].value,'_parent');this.options[0].selected=true" name="select">
                                    <option selected="selected" value="<?= base_url(@$cate_curent->alias.'-th'.@$cate_curent->id);?>">Sắp xếp theo</option>
                                    <option value="<?= base_url(@$cate_curent->alias.'-th'.@$cate_curent->id);?>">
                                        Mới nhất
                                    </option>

                                    <option value="<?=base_url(@$cate_curent->alias.'-ts'.@$cate_curent->id.$ts);?>">
                                        Giá tăng
                                    </option>
...
//                                 if($z==6) break;
            ...
            <?php if (($list) == null) {
                echo'<h2 class="text-center null_list">Không có sản phẩm nào thuộc thương hiệu này mới  !</h2>';
            }?>
