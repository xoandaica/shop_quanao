<div id="ctl00_divAlt1" class="altcontent1 cmszone">
    ...
    <div class="container text-right Module Module-141">
        <ol class="breadcrumb">
            ...
            <li>
                <a class="active" href=""><?= $pro_first->project_name; ?></a>
            </li>
        </ol>
    </div>
</div>
                    ...
                    <div id="ctl00_mainContent_ctl00_ctl00_pnlInnerWrap">
                        <section class="news-live">
                            <div class="text-justify mrb20">
                                <h1 class="title-page"><?= $pro_first->project_name; ?></h1>

                                <div></div>
                                <p><img alt="" src="<?= base_url($pro_first->project_image) ?>"
                            ...
                            <a class="back-button"
                               href="<?= base_url($cate_current->alias . '-pj' . $cate_current->id) ?>">
