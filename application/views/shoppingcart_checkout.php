...
<article>
    ...
    <div class="col-lg-807_old col-md-12 col-sm-12 col-xs-12">
                        ...
                        //    print_r($cart); die(); $v['lang' == @$this->language
                            ...
                            foreach ($cart as $key => $v) {
                                ...
                                <tr style="padding: 10px 2px;height: 31px; margin-bottom: 10px !important; ">
                                    <td class="hidden-xs">
                                        <a href="#"  title="">
                                            <?= isset($v['image'])?'<img  style="width: 200px; height:150px; margin:10px"
        ...
        <?php if (!empty($cart)) { ?>
            <div style="float: left;margin-right: 5px;" class="" >
                <div class="button-green buy_pro">
                    <a  href="<?= base_url('dat-hang')?>"  style="cursor: pointer;" data-target=".bs-example-modal-sm_checkout_old" data-toggle="modal_old">
                        <i class="icons icon-basket-2"></i><?= lang('thuchiendathang')?></a>
                </div>
            </div>
            <div style="float: left;margin-right: 5px;" class="" onclick="window.history.go(-2);">
                <div class="button-green buy_pro" buy_pro>
                    <i class="icons icon-basket-2 "></i>
                    <a href="" ><?= lang('continueshopping')?></a>
                </div>
            </div>
            <div style="float: left;margin-right: 5px;" class="">
                <div class="button-green buy_pro">
                    <a href="<?= base_url('shoppingcart/destroy_cart') ?>" class=""
                       style="" onclick="return confirm('Hủy giỏ hàng sẽ xóa toàn bộ sản phẩm trong giỏ hàng của bạn?')">
                        <i class="icons icon-basket-2"></i><?= lang('cancellationcart')?>
                    </a>
                </div>
            </div>
        <?php }
