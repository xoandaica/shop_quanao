                    ...
                    <?php if (!empty($cart)) {
                        ...
                        <div class="total ">
                            ...
                            <div class="">
                                ...
                                <label class="col-sm-4 col-sm-4 col-xs-4 ">
...
<div class="pull-left">
    <form action="<?= base_url('checkout-baokim'); ?>" class="validate form-horizontal" method="post" role="form">
        ...
        <input type="hidden" id="payer_name" name="payer_name" value="<?= @$user_item->fullname; ?>"
               placeholder="họ tên">
        <input type="hidden" id="payer_phone_no" name="payer_phone_no" value="<?= @$user_item->phone; ?>"
               placeholder="Số điện thoại">
        <input type="hidden" id="payer_email" name="payer_email" value="<?= @$user_item->email; ?>" placeholder="Email">
        <input type="hidden" id="address_hidden" name="address_hidden" value="<?= @$user_item->adress; ?>"
               placeholder="Địa chỉ">
        ...
        <input type="hidden" id="total_amount" value="<?= (@$total); ?>" name="total_amount"
               placeholder="Số tiền phải thanh toán">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <?php
        if ($this->session->userdata('userid')) {
            echo '
                          <button  name="sendcart_bk"  id="btn-login"  class="btn btn-blue">Thanh Toán Trực Tuyến</button> ';
        } else {
            echo '<a  data-toggle="modal" data-target=".bs-example-modal-sm">
                         <button  id="btn-login"  class="btn btn-blue"  >Thanh Toán Trực Tuyến</button>
                     </a>';
        }
        ?>
