...
<div class="box_title_x  w_100">
    ...
    <a href="" class="back_link" title=""><?= $pro_first->name?></a>
    ...
    <div class="col-md-8 col-sm-7 col-xs-6 col-480-12">
        <div class="sub_prod_detail">
            ...
            <section class="col-md-9 col-sm-9 col-xs-12 " style="margin-top: 5px;">
                ...
                <div style="float: left; margin-top: -5px;" class="g-plusone" data-annotation="inline" data-width="300"></div>
                </br>
                </br>
                <div class="qantam btn btn-xs btn-default " style="">
                    <div>
            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <div class="price_news_dentail">
                        <?= $pro_first->price_sale > 0 ? ' ' . number_format($pro_first->price_sale) . 'VNĐ' : lang('contact') ?>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="price_parent">Giá xỉ:</div>
                    <div class="clearfix"></div>
                    <div class="price_news_dentail">
...
<div class="clearfix"></div>
<div style="border: 1px #aaa solid; padding: 15px 75px 15px 13px; margin-bottom: 15px">
    <div class="row">
        <div class="col-md-7" style="">
            <h2 style="margin: 0px">
                <?= @$pro_first->code ?> </h2>
            <div style="color: red; font-weight: bold; font-size: 20px">
                <?= $pro_first->price_sale > 0 ? ' ' . number_format($pro_first->price_sale) . 'đ' : lang('contact') ?>
            </div>
        </div>
            ...
            <div class="sub_prod_home">
                ...
                <div class="prince_retail clearfix">
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="row">
                            <div class="prince_new_retail">Giá lẻ: <span style="font-size: 14px; color: #ff0000; font-weight: bold">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <div class="row">
                        <div class="pull-right">
                            <a style="cursor: pointer;" onclick="add_cart(<?= @$p->id; ?>)" class="fa fa-shopping-cart cart_pro_home"></a>
                        </div>
                    </div>
                </div>
            </div>
