...
class Menu extends MY_Controller
{
    ...
    public function menulist()
    {
        ...
        $data['menu_top'] = $this->menu_model->GetData('menu',array('position'=>'top','lang'=>$this->language),array('sort','esc'));
        $data['menu_left'] = $this->menu_model->GetData('menu',array('position'=>'left','lang'=>$this->language),array('sort','esc'));
        $data['menu_right'] = $this->menu_model->GetData('menu',array('position'=>'right','lang'=>$this->language),array('sort','esc'));
        $data['menu_bottom'] = $this->menu_model->GetData('menu',array('position'=>'bottom','lang'=>$this->language),array('sort','esc'));
...
//            print_r($_FILES['userfile']);die();
        ...
        if($this->input->get('p')){
            $data['menu'] = $this->menu_model->Get_where('menu',array('position'=>$this->input->get('p'),'lang'=>$this->language));
